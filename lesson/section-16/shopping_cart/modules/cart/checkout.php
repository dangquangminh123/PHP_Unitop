                            ...
                            <div id="order-review-wp" class="fl-right">
                                ...
                                <div class="detail">
                                    <table class="shop-table">
                                        ...
                                        <tbody>
                                            <tr class="cart-item">
                                                <td class="product-name">Iphone 7 Gray<strong class="product-quantity">x
                                                        1</strong></td>
                                                <td class="product-total">7,500,000đ</td>
                                            </tr>
                                            <tr class="cart-item">
                                                <td class="product-name">Iphone 6S Blue<strong
                                                        class="product-quantity">x 1</strong></td>
                                        ...
                                        <ul id="payment_methods">
                                            <li>
                                                <input type="radio" checked="checked" id="direct-payment"
                                                    name="payment-method" value="online">
